      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4">
              ...
              <Button asChild variant="secondary" size="lg" className="w-full justify-start glow-secondary">
                <a href="https://api.leadconnectorhq.com/widget/booking/57xP6cJ3bacw7ZTpsRXe" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                  <Calendar size={20} />
              ...
              <Button asChild variant="outline" size="lg" className="w-full justify-start bg-[#25D366]/10 hover:bg-[#25D366]/20 border-[#25D366]/30">
                <a href="https://wa.me/33749410774" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
              ...
              <Button asChild variant="outline" size="lg" className="w-full justify-start bg-[#0A66C2]/10 hover:bg-[#0A66C2]/20 border-[#0A66C2]/30">
                <a href="https://www.linkedin.com/company/agendac-sas/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
        ...
        <div className="border-t border-border/30 pt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <span className="text-xl font-bold text-foreground block mb-2">Agendac</span>
            ...
            <div className="flex items-center justify-center gap-3">
              {[
                { href: "https://www.youtube.com/@agendac-fr", label: "YouTube", icon: <Youtube size={18} />, hoverColor: "hover:text-[#FF0000]" },
                { href: "https://www.linkedin.com/company/agendac-sas/", label: "LinkedIn", icon: <Linkedin size={18} />, hoverColor: "hover:text-[#0A66C2]" },
              ].map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  ...
                  className={`w-10 h-10 rounded-xl glass flex items-center justify-center text-muted-foreground ${social.hoverColor} transition-all duration-300 hover:-translate-y-1`}
                >
                  {social.icon}
                </a>
              ))}
              <a href="https://www.facebook.com/agendac.fr" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                className="w-10 h-10 rounded-xl glass flex items-center justify-center text-muted-foreground hover:text-[#1877F2] transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="https://www.instagram.com/agendac.fr" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="w-10 h-10 rounded-xl glass flex items-center justify-center text-muted-foreground hover:text-[#E4405F] transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="https://x.com/agendac_sas" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)"
                className="w-10 h-10 rounded-xl glass flex items-center justify-center text-muted-foreground hover:text-foreground transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6 pt-6 border-t border-border/20">
            ...
            <div className="flex items-center gap-6 text-sm">
              <a href="https://agendacsas.fr/mentions-legales" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                Mentions légales
              </a>
              <a href="https://agendacsas.fr/confidentialitc3a9" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
