          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="w-10 h-10 rounded-xl glass flex items-center justify-center text-muted-foreground hover:text-[#FF0000] transition-all duration-300 hover:-translate-y-1"
              >
                <Youtube size={18} />
              </a>
              <a
                ...
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-10 h-10 rounded-xl glass flex items-center justify-center text-muted-foreground hover:text-[#0A66C2] transition-all duration-300 hover:-translate-y-1"
              >
                <Linkedin size={18} />
              </a>
              <a
            ...
            <div className="text-right">
              <ul className="space-y-1 text-muted-foreground text-sm">
                ...
                <li className="text-xs">Une société du groupe AELU-MEDIA LLC</li>
              </ul>
            </div>
          </div>
