      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <AnimatedSection delay={0.3} direction="up">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
            <div className="glass-card p-6 text-center bg-white/80 hover:-translate-y-1 hover:scale-[1.02] transition-transform duration-300">
        ...
        <AnimatedSection delay={0.4} direction="scale">
          <div className="max-w-4xl mx-auto">
            <div className="glass-card p-3 border-gradient glow-primary bg-white/80">
