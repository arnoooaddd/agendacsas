        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <AnimatedSection>
            <div className="inline-flex items-center gap-2 glass-card px-4 py-2 mb-6">
              ...
              <span className="text-sm font-medium text-foreground/80">Moments partagés</span>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.2}>
            <p className="text-muted-foreground text-lg">Des relations humaines au cœur de notre approche.</p>
          </AnimatedSection>
        </div>
