...
export const blogArticles: BlogArticle[] = [
  ...
  },
  {
    ...
    title: "Combien coûte la publicité dans la rénovation de l'habitat en 2026 ?",
    metaDescription: "Google Ads, Facebook Ads : combien coûte vraiment la publicité en rénovation ? Budget, coût par lead et stratégie pour une acquisition rentable.",
    excerpt: "Pas de débat : si vous voulez scaler votre acquisition clients en rénovation, vous devez acheter de la visibilité. La vraie question → combien ça coûte réellement et ce que vous obtenez derrière.",
    ...
    keywords: [
      "coût publicité rénovation habitat",
      "coût lead rénovation",
      "coût acquisition client rénovation",
