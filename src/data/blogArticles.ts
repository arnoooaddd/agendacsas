...
export const blogArticles: BlogArticle[] = [
  ...
  {
    slug: "marketing-local-entreprise-renovation",
    title: "Marketing local rénovation : comment devenir la référence de votre zone et générer plus de rendez-vous",
    metaDescription: "Marketing local pour entreprise de rénovation : visibilité, crédibilité, tunnel commercial et actions concrètes pour générer plus de rendez-vous qualifiés.",
    excerpt: "Le marketing local en rénovation ne se limite pas à être visible. Découvrez comment structurer votre présence locale pour générer plus de demandes qualifiées et transformer cette visibilité en rendez-vous.",
    coverImage: "marketing-renovation-habitat",
    author: "Arnaud UTILLE",
    date: "2026-04-29",
    readTime: "7 min",
    featured: false,
    tags: ["Marketing", "Acquisition", "Rénovation"],
    keywords: [
      "marketing local rénovation",
      "marketing local entreprise rénovation",
      "acquisition clients rénovation",
      ...
      "marketing BTP local",
      "génération de leads rénovation",
      "visibilité locale rénovation",
      "automatisation commerciale rénovation",
    ],
  },
];